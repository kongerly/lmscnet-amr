"""Run or resume a baseline validation tuning sweep without test access."""
...
from na_lmscnet.training import run_validation_sweep  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run or resume a baseline validation tuning sweep without test access."
    )
    parser.add_argument("--sweep", type=Path, required=True, help="Sweep contract YAML path")
...
def main(argv: list[str] | None = None) -> int:
    ...
    with (
        ...
        summary = run_validation_sweep(
            sweep_contract_path=args.sweep,
        ...
        json.dumps(
            {
                ...
                "selected_config_sha256": summary["selected_config_sha256"],
