"""Generate the external NA-LMSCNet validation report."""
...
from na_lmscnet.evaluation.na_lmscnet_report import generate_na_lmscnet_report  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a validation-only NA-LMSCNet report.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    with RadioML2016HDF5Dataset(split="validation", **common) as validation_dataset:
        manifest = generate_na_lmscnet_report(
            ...
            report_generation_project_commit=_project_commit(),
        ...
        json.dumps(
            {
                ...
                "run_count": manifest["bindings"]["run_count"],
                "test_accessed": manifest["test_accessed"],
                "summary_sha256": _sha256_file(args.output_root / "multi-seed-summary.json"),
            },
            sort_keys=True,
        )
    )
