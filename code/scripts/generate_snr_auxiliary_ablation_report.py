"""Generate the validation-only w/o SNR auxiliary comparison report."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Report the seed-13 w/o SNR auxiliary ablation.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    with RadioML2016HDF5Dataset(split="validation", **common) as validation_dataset:
        manifest = generate_snr_auxiliary_ablation_report(
